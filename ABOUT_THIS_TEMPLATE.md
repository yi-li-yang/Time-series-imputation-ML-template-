...
├── time_series_imputation_ml             # The main python package for the project
...
e.g: `cat time_series_imputation_ml/VERSION` will get the project version without harming
